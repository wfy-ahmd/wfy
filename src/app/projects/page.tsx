    ...
    <main id="main-content" className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
          ...
          frontend and full-stack development, focusing on modern frameworks,
          clean architecture, intuitive interfaces and solving real-world
          problems with efficient, scalable user experiences.
        </p>
      </motion.div>
