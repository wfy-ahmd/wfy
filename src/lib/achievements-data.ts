export const achievementsData = [
  {
    title: '1st Place – INSL North Central Provincial Competition',
    organization: 'IEEE Young Professionals Sri Lanka',
    period: '2025',
    image: '/achievements/insl-2025.jpg', // ADD IMAGE LATER
    description:
      'Secured 1st Place at the INSL North Central Provincial Competition 2025 as a member of Team TechSnatchers.',
    achievements: [
      'Team TechSnatchers',
      'Provincial Level Recognition',
      'Innovation & Technical Excellence',
    ],
  },
  {
    title: '1st Place – RUSL XTREME Mini-Code Competition',
    organization: 'IEEE Student Branch – Rajarata University of Sri Lanka',
    period: '2025',
    image: '/achievements/rusl-xtreme-2025.jpg', // ADD IMAGE LATER
    description:
      'Won 1st Place at the RUSL XTREME Mini-Code Competition 2025 as the Team Leader of Team CodeNova7.',
    achievements: [
      'Team Leader – CodeNova7',
