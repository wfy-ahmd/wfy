...
export const Leadership = () => {
  ...
  return (
    ...
    >
      <SectionHeading
        heading="Leadership & Volunteering Contributions"
        content="Roles where I contributed through mentoring, coordination, and community impact."
      />

      <div className="relative max-w-screen-md">
        {leadershipData.map(
          ({ title, company, description, period, technologies }) => (
            <div
              key={company + title}
